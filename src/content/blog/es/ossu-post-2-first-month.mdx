...
canonicalUrl: "https://unicornio.dev/blog/ossu-post-2-first-month"
...
Más adelante voy a escribir un artículo completo sobre el curso, sus ventajas y dificultades; así que <SimpleLink path="https://unicornio.dev/tags/ossu">les recomiendo estar atentos al blog</SimpleLink> y a <SimpleLink path="https://youtube.com/@unicorniodev">YouTube donde subiré un video con mis opiniones</SimpleLink>.  
...
Me parece clave dedicarle el tiempo necesario a aprender correctamente la sintaxis de un nuevo lenguaje, pero además, <SimpleLink path="https://unicornio.dev/blog/why-learn-python">Python tiene un montón de ventajas</SimpleLink>, por las cuales preferí invertir y dedicarle un poco más de tiempo y esfuerzo.  
